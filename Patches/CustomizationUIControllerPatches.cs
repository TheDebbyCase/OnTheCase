...
namespace OnTheCase.Patches
{
    ...
    public class CustomizationUIControllerButtonBuyPatch
    {
        ...
        public static IEnumerable<CodeInstruction> Transpiler(IEnumerable<CodeInstruction> instructions, ILGenerator generator)
        {
            ...
            MethodInfo newMethod = AccessTools.Method(typeof(CaseUtils), nameof(CaseUtils.SetBought), new Type[] { typeof(int), typeof(bool) });
    ...
    public class CustomizationUIControllerButtonItemPatch
    {
        ...
        public static IEnumerable<CodeInstruction> Transpiler(IEnumerable<CodeInstruction> instructions, ILGenerator generator)
        {
            ...
            MethodInfo newMethod = AccessTools.Method(typeof(CaseUtils), nameof(CaseUtils.IsBought), new Type[] { typeof(int) });
